        ...
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 pt-8">
            ...
            <div className="text-center mt-6 text-xs text-gray-600">
              Designed with <span className="text-red-500">♥</span> by <a href="https://rijoan.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Md Rijoan Maruf</a>
            </div>
          </div>
        </div>
      </div>
